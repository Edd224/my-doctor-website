...
import data from "../../../public/data/LactosaData.json";
// Importujeme dáta z JSON súboru
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row">
                                {jsonData.whatYouNeed.map((item: WhatYouNeedItem, index: number) => (
                                    <motion.div
                                        key={index}
                                        className="w-full text-text sm:w-1/2 bg-gradient-to-b from-main/40 to-primary space-y-4 p-4 sm:p-8 m-0 sm:m-2 flex flex-col  items-center rounded-10 hover:scale-105 duration-500 shadow-md"
                                        variants={containerVariants}
                                        custom={index + 3}
                                    >
